 ...
 * @author cloudy_place
 */
public class DistributorInsertControll extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("username") == null) {// set login
            ...
            if (account.getRole().getRoleId() == 2) {
                ...
                request.getRequestDispatcher("view/Manage/DistributorManage/DistributorInsert.jsp").forward(request, response);
            }
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        distributorDB.insertDistributor(d);
