 ...
 * @author cloudy_place
 */
public class searchMedicineControll extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("username") == null) {// set login
            ...
            MedicineDB medDB = new MedicineDB();
            List<Medicine> list = medDB.searchByMedicineName(txtSearch);
            request.setAttribute("listMedPage", list);
