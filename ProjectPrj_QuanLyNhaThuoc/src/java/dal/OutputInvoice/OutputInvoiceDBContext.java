...
public class OutputInvoiceDBContext extends DBContext {
    ...
    public static void main(String[] args) {
        ...
        OutputInvoice oi = db.getOutInvoiceIdMaxId();
        System.out.println(oi.getOutInvoiceId());
        OutputInvoiceDetail o = new OutputInvoiceDetail(oi, new Medicine(42), 2);
        db.insertOutInvoiceDetail(o);
    }
