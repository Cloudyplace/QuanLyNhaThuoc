                    ...
                    <div class="col-12 col-lg-12">
                        ...
                        <nav aria-label="breadcrumb" class="main-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Chi tiết hóa đơn bán</li>
                            </ol>
                        </nav>
                            ...
                            <div class="page-tools">
                                <div class="action-buttons">
                                    <a class="btn bg-white btn-light mx-1px text-95" href="#" data-title="Print">
                                        <i class="mr-1 fa fa-print text-proutary-m1 text-120 w-2"></i>
                                        In
                                    </a>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div>
                                    <span class="text-sm text-grey-m2 align-middle">Nhân viên: </span>
                            ...
                            <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                                ...
                                <div class="text-grey-m2">
                                    ...
                                    <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">ID: </span> ${OutInvoiceAndAccount.outInvoiceId}</div>
                                    <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Tên khách hàng: </span> ${OutInvoiceAndAccount.customerName}</div>
                                    <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Số điện thoại KH: </span> ${OutInvoiceAndAccount.customerPhone}</div>

                                    <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Ngày phát hành: </span>${OutInvoiceAndAccount.saleDate}</div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 col-sm-7 text-grey-d2 text-95 mt-2 mt-lg-0">
                                    Ghi chú khi thanh toán: ${OutInvoiceAndAccount.note}
                                </div>
                            ...
                            <div>
                                <a href="outputInvoiceEdit?id=${OutInvoiceAndAccount.outInvoiceId}" class="btn btn-info btn-bold px-4 float-right mt-3 mt-lg-0">Edit</a>
                                <br/>
                                <br/>
                                <br/>
                                <br/>
