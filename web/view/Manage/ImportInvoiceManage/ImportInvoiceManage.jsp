                                        ...
                                        <c:forEach items="${listImInvoicePage}" var="o">
                                            <tr>
                                                ...
                                                <td><a class="table-link" href="imInvoiceDetail?id=${o.imInvoiceId}">
                                                    ...
                                                    <a href="imImvoiceEdit?id=${o.imInvoiceId}" class="table-link">
                                                        <span class="fa-stack">
                                                            <i class="fa fa-square fa-stack-2x"></i>
            ...
            <div class="tagPage">
                <div class="tag">
                    <c:forEach begin="1" end="${endPage}" var="i">
                        <a class="${tagPage==i?"active":""}" href="importInvoiceManage?indexPage=${i}"> ${i}</a> <!--chon the nao thi the aay mang active-->
                    </c:forEach>
                </div>
            </div>
        </div>
