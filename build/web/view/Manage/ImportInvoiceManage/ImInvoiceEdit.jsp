...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/Manage/ImportInvoice/ImInvoiceDetail.css">
    ...
    <body>
        <jsp:include page="../../Home/Header.jsp"></jsp:include>
            ...
            <form action="imImvoiceEdit" method="POST">
                        ...
                        <div class="col-12 col-lg-12">
                            ...
                            <nav aria-label="breadcrumb" class="main-breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="imInvoiceDetail?id=${ImvoiceAndDistributor.imInvoiceId}">Chi tiết hóa đơn nhập</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Chỉnh sửa hóa đơn nhập</li>
                            </ol>
                        </nav>
                                        ...
                                        <span class="text-600 text-90 text-blue align-middle">
                                            <select name="disId" >
                                                <c:forEach items="${AllDistributor}" var="d">
                                                    <option 
                                                        <c:if test="${ImvoiceAndDistributor.distributor.distributorId eq d.distributorId}">
                                                            selected="selected"
                                                        </c:if>
                                ...
                                <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                                    ...
                                    <div class="text-grey-m2">
                                        ...
                                        <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> 
                                            <span class="text-600 text-90">ID: </span>${ImvoiceAndDistributor.imInvoiceId}<input type="hidden" name="imInvoiceId" value="${ImvoiceAndDistributor.imInvoiceId}"></div>

                                        <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i>
                                            <span class="text-600 text-90">Ngày phát hành: </span><input type="date" name="imDate" value="${ImvoiceAndDistributor.imDate}"></div>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="row mt-3">
                                    <div class="col-12 col-sm-7 text-grey-d2 text-95 mt-2 mt-lg-0">
                                        Ghi chú khi thanh toán: <input name="note" value="${ImvoiceAndDistributor.note}">
                                    </div>
